    ...
    return (
      <section className={`grid grid-cols-1 md:grid-cols-12 items-center px-8 ${classes}`}>
        <div className='col-span-7 order-2 text-center md:text-left'>
          <h3 className='hidden md:block text-2xl mb-2 font-bold text-blue-300'>
        ...
        <div className='col-span-5 order-1 md:order-3'>
          <h3 className='block md:hidden text-base mb-2 font-bold text-blue-300 mt-8 text-center'>
              Download QuranTalk on Android &amp; iOS
          </h3>
